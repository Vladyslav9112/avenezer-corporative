    ...
    <div className="mx-auto max-w-3xl p-6">
      <div className="rounded-2xl bg-[var(--bg-surface)] p-6 shadow-sm">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          <div className="rounded-2xl border border-black/10 bg-white p-4">
            ...
            <p className="mt-2 text-sm text-[var(--text-muted)]">
              AVER — це людина, яка допомагає бізнесу правильно зайти в систему
              і отримати результат через довіру, рекомендацію та користь.
            </p>
        ...
        <div className="mt-6 text-sm text-[var(--text-muted)]">
          <Link className="underline" href={`/${locale}/terms`} target="_blank">
            Terms
          </Link>{" "}
          ·{" "}
          <Link className="underline" href={`/${locale}/legal`} target="_blank">
            Legal
          </Link>
        </div>
      </div>
