  ...
  return (
    <div className="mx-auto max-w-md p-6">
      ...
      <p className="mt-2 text-sm text-[var(--text-muted)]">
        {t("forgotHint", { default: "Enter your email and we will send a reset link." })}
      </p>
      ...
      >
        ...
        {sent && (
          <p className="text-sm text-green-700">
            {t("forgotSent", {
              default: "If the email exists, we sent a reset link.",
            })}
          </p>
        )}
        ...
        >
          {loading
            ...
            : t("forgotBtn", { default: "Send reset link" })}
        </button>

        <div className="text-sm text-[var(--text-main)]">
          <Link className="underline" href={`/${locale}/auth/login`}>
